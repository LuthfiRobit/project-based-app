...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex justify-content-between align-items-center">
                <h4 class="text-black font-w600">Roles & Permissions | Role Management</h4>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            ...
                            <span>Gunakan fitur ini untuk mengelola data aktivitas role dengan efisien. Anda dapat melakukan
                                hal-hal berikut:</span>
                            <ul>
                                <li>Melihat list role.</li>
                                <li>Menambah role.</li>
                            </ul>
                        </div>
    ...
    @include('rbac.role.components.create')
    @include('rbac.role.components.detail')
    @include('rbac.role.components.edit')
    @include('rbac.role.components.permission')
@endsection
...
@section('this-page-scripts')
    ...
    @include('rbac.role.scripts.list')
    @include('rbac.role.scripts.action')
    @include('rbac.role.scripts.store')
    @include('rbac.role.scripts.update')
    @include('rbac.role.scripts.permissionStore')
@endsection
