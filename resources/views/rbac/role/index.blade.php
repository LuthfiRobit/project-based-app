    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex justify-content-between align-items-center">
                <h4 class="text-black font-w600">RBAC | Role Management</h4>
            </div>
...
@section('this-page-scripts')
    ...
    @include('rbac.role.scripts.datatable-init')
    @include('rbac.role.scripts.action-handler')
    @include('rbac.role.scripts.modal-create-handler')
    @include('rbac.role.scripts.modal-edit-handler')
    @include('rbac.role.scripts.modal-role-permission-handler')
@endsection
