<script>
    $('#example').on('click', '.dropdown-item', function() {
        ...
        const url = '{{ route('master.ruang-kelas.show', ':id') }}'.replace(':id', dataId);
    ...
    function handleShow(data) {
        ...
        $('#detail_nama_tingkat').text(data.nama_tingkat || 'N/A');
        $('#detail_nama_jurusan').text(data.nama_jurusan || 'N/A');
        $('#detail_nama_ruang_kelas').text(data.nama_ruang_kelas || 'N/A');
        $('#detail_wali_kelas').text(data.wali_kelas || 'Belum ditentukan');
        $('#detail_status').text(data.status || 'N/A');
        $('#modalDetail').modal('show');
    }

    function handleEdit(data) {
        $('#editForm').attr('data-id', data.id_ruang_kelas);
