    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Ruang Kelas</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Ruang Kelas</h4>
                            <span class="fs-12 text-muted">Kelola ruang kelas berdasarkan tingkat, jurusan, dan tahun
                                pelajaran.</span>
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 20%;" class="text-start align-middle">Nama Ruang Kelas</th>
                                        <th style="width: 10%;" class="text-start align-middle">Tingkat</th>
                                        <th style="width: 10%;" class="text-start align-middle">Jurusan</th>
                                        <th style="width: 15%;" class="text-start align-middle">Tahun Pelajaran</th>
                                        <th style="width: 25%;" class="text-start align-middle">Wali Kelas</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Ruang kelas adalah kombinasi dari tingkat, jurusan (jika ada), tahun
                            pelajaran, dan wali kelas. Contoh: "XII IPA 2", "7A".
                        </div>
                    </div>
                </div>
            </div>
