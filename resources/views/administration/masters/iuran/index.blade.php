...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                <small class="text-muted">Master Keuangan -</small>
                <h4 class="text-dark fw-semibold mb-0">Iuran</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Iuran</h4>
                            <span class="fs-12 text-muted">Kelola iuran, filter status, tambah data baru, dan ekspor
                                data.</span>
                        </div>
                        <div class="d-flex align-items-center gap-1">
                            <div class="">
                                <select id="filter_tahun" class="selectpicker form-control wide form-select-md"
                                    data-live-search="false" aria-describedby="instansi-feedback" placeholder="Pilih Tahun"
                                    required>
                                    <option value="">Semua</option>
                                    @foreach ($tahunPelajaranList as $tp)
                                        <option value="{{ $tp->id_tahun_pelajaran }}">{{ $tp->nama_tahun_pelajaran }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 25%;" class="text-start align-middle">Tahun Pelajaran</th>
                                        <th style="width: 35%;" class="text-start align-middle">Iuran</th>
                                        <th style="width: 25%;" class="text-start align-middle">Nominal</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Fitur ini digunakan untuk mengelola iuran. Anda dapat menambahkan,
                            mengubah, atau mengaktifkan iuran sesuai tahun pelajaran yang relevan. Hanya satu iuran
                            aktif per tahun pelajaran.
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('administration.masters.iuran.components.create')
    {{-- @include('administration.masters.iuran.components.import') --}}
    @include('administration.masters.iuran.components.detail')
    @include('administration.masters.iuran.components.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.iuran.scripts.datatable-init')
    @include('administration.masters.iuran.scripts.modal-create-handler')
    @include('administration.masters.iuran.scripts.actions-handler')
    @include('administration.masters.iuran.scripts.modal-edit-handler')
    {{-- @include('administration.masters.iuran.scripts.modal-import-handler') --}}
    @include('administration.masters.iuran.scripts.status-update-handler')
@endsection
