...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                <small class="text-muted">Master Akademik -</small>
                <h4 class="text-dark fw-semibold mb-0">Semester</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Semester</h4>
                            <span class="fs-12 text-muted">Kelola semester, filter status, tambah data baru, dan ekspor
                                data.</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 gy-2">
                            <div class="col-12 col-md d-flex flex-wrap gap-2">
                                ...
                                <button class="btn-update-status btn btn-sm btn-danger" data-status="inactive" disabled>
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 35%;" class="text-start align-middle">Tahun Pelajaran</th>
                                        <th style="width: 25%;" class="text-start align-middle">Semester</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Fitur ini digunakan untuk mengelola semester. Anda dapat menambahkan,
                            mengubah, atau mengaktifkan semester sesuai tahun pelajaran yang relevan. Hanya satu semester
    ...
    @include('administration.masters.semester.components.create')
    {{-- @include('administration.masters.semester.components.import') --}}
    @include('administration.masters.semester.components.detail')
    @include('administration.masters.semester.components.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.semester.scripts.datatable-init')
    @include('administration.masters.semester.scripts.modal-create-handler')
    @include('administration.masters.semester.scripts.modal-edit-handler')
    {{-- @include('administration.masters.semester.scripts.modal-import-handler') --}}
    @include('administration.masters.semester.scripts.status-activated-handler')
    @include('administration.masters.semester.scripts.actions-handler')
@endsection
