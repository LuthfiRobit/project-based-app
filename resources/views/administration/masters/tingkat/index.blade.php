...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Tingkat Pendidikan</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Tingkat</h4>
                            <span class="fs-12 text-muted">Kelola data tingkat pendidikan berdasarkan jenjang.</span>
                        </div>
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <div>
                                <select id="filter_jenjang" class="selectpicker form-control wide form-select-md"
                                    data-live-search="true" required aria-label="Pilih Jenjang" data-size="5"
                    ...
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 30%;" class="text-start align-middle">Tingkat</th>
                                        <th style="width: 30%;" class="text-start align-middle">Jenjang</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Data tingkat menentukan level kelas seperti 1, 2, ... XII dalam
                            jenjang SD, SMP, SMA, dll.
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- Include modals --}}
    @include('administration.masters.tingkat.components.create')
    @include('administration.masters.tingkat.components.edit')
    @include('administration.masters.tingkat.components.detail')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.tingkat.scripts.datatable-init')
    @include('administration.masters.tingkat.scripts.modal-create-handler')
    @include('administration.masters.tingkat.scripts.modal-edit-handler')
    @include('administration.masters.tingkat.scripts.actions-handler')
    @include('administration.masters.tingkat.scripts.status-update-handler')
@endsection
