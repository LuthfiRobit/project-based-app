        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="createForm" method="post" class="form-sm">
                    <div class="mb-3">
                        <label for="nama_keringanan" class="form-label">Nama Keringanan</label>
                        <input type="text" class="form-control form-control-sm" id="nama_keringanan"
                            name="nama_keringanan" placeholder="Masukkan nama keringanan" aria-label="Nama Keringanan"
