...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Keringanan</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Keringanan</h4>
                            <span class="fs-12 text-muted">Kelola keringanan, filter status, tambah data baru, dan ekspor
                                data.</span>
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 65%;" class="text-start align-middle">Keringanan</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Fitur ini digunakan untuk mengelola keringanan. Anda dapat
                            menambahkan,
                            mengubah, atau mengaktifkan keringanan sesuai tahun pelajaran yang relevan. Hanya satu
                            keringanan
    ...
    @include('administration.masters.keringanan.components.create')
    {{-- @include('administration.masters.keringanan.components.import') --}}
    @include('administration.masters.keringanan.components.detail')
    @include('administration.masters.keringanan.components.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.keringanan.scripts.datatable-init')
    @include('administration.masters.keringanan.scripts.modal-create-handler')
    @include('administration.masters.keringanan.scripts.actions-handler')
    @include('administration.masters.keringanan.scripts.modal-edit-handler')
    {{-- @include('administration.masters.keringanan.scripts.modal-import-handler') --}}
    @include('administration.masters.keringanan.scripts.status-update-handler')
@endsection
