            ...
            <div class="modal-body">
                ...
                <form id="editForm" method="post" class="form-sm" data-id="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="nama_tahun_pelajaran"
                            name="nama_tahun_pelajaran" placeholder="Masukkan jabatan" aria-label="Nama Tahun Ajaran"
