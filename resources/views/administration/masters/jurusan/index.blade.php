    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Jurusan</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Jurusan</h4>
                            <span class="fs-12 text-muted">Kelola data jurusan berdasarkan jenjang pendidikan.</span>
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap"
                                ...
                                <thead>
                                    <tr class="text-center text-muted text-uppercase">
                                        ...
                                        <th style="width: 30%;" class="text-start align-middle">Jurusan</th>
                        ...
                        <div class="alert alert-primary mt-3">
                            <strong>Catatan:</strong> Jurusan digunakan untuk jenjang pendidikan menengah atas seperti SMA,
                            SMK, atau MA. Contoh: IPA, IPS, RPL, TKJ.
                        </div>
                    </div>
                </div>
            </div>
